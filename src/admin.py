...
from models import db, Users, User_Favorites, Favorite_Characters, Favorite_Planets, Favorite_Vehicles, Characters, Planets, Vehicles
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(User_Favorites, db.session))
